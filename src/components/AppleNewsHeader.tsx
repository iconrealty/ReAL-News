...
export const AppleNewsHeader: React.FC<AppleNewsHeaderProps> = ({
  ...
  const currentNum = parseFloat((fredRate || '6.81%').replace(/[^0-9.]/g, '')) || 6.81;
            ...
            <div className="flex items-center gap-3 sm:hidden">
              ...
              >
                ...
                <div className="flex items-center justify-end gap-1.5 pt-0.5">
                  <span className="text-xl font-black text-slate-950 font-sans tracking-tight leading-none group-hover:text-[#FA2D48] transition-colors">
                    {fredRate}
                  </span>
                </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-slate-500 font-semibold pt-0.5">
                ...
                <span className="font-medium text-slate-400">{asOfDate || 'Live Market'}</span>
              </div>
            </button>
